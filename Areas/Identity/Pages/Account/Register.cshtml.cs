...
namespace Stock_system.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                //fetch and verify roles assigned for login prep
            ...
            if (ModelState.IsValid)
            {
               ...
               // await _emailStore.SetEmailAsync(user, Input.UserName, CancellationToken.None);
                ...
                if (result.Succeeded)
                {
                    ...
                    {                                                      //email        
                        return RedirectToPage("RegisterConfirmation", new { role = Input.UserName, returnUrl = returnUrl });
                    }
                    else
                    {
